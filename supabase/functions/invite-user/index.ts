...
Deno.serve(async(req:Request)=>{
 ...
 try{
  ...
  const {data,error}=await admin.auth.admin.inviteUserByEmail(body.email,{data:{full_name:body.full_name,first_access_required:true},redirectTo:"https://cuida.idealizandoedu.com.br/login"});
